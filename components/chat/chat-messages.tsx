...
export const ChatMessages = ({
  ...
  return (
    <div
      className="flex-1 flex flex-col py-4 overflow-y-auto scrollbar-thumb-rounded-full scrollbar-track-rounded-full scrollbar scrollbar-thumb-zinc-300 dark:scrollbar-thumb-zinc-600 scrollbar-w-[7px]"
      ref={chatRef}
    >
